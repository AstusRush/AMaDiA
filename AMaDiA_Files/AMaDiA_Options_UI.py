...
class Ui_AMaDiA_Options(object):
    def setupUi(self, AMaDiA_Options):
        ...
        self.gridLayout_4.addWidget(self.fontComboBox, 19, 0, 1, 1)
        ...
        self.cb_O_Units = QtWidgets.QCheckBox(self.L_O)
        self.cb_O_Units.setObjectName("cb_O_Units")
        self.gridLayout_4.addWidget(self.cb_O_Units, 15, 0, 1, 1)
...
"This can clutter the context menus, flood you with neglectible errors and unlock dangerous functions that should only be used if you know what you are doing."))
        ...
        self.cb_O_Units.setToolTip(_translate("AMaDiA_Options", "If checked the calculator is sensitive for units.<br>\n"
"For example m is no longer a variable but instead \"meter\"."))
        self.cb_O_Units.setText(_translate("AMaDiA_Options", "Enable Units"))
        ...
        self.Label_O_HCopyStandard.setText(_translate("AMaDiA_Options", "Set what ctrl+c should try to copy when having a sinlge history item selected"))
...
from AGeLib.AGeMain import MTabWidget
