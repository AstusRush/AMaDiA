...
#NOTE: For AGeLib to work properly on Wayland the compatibility-layer XWayland must be used:
# Type in the console (e.g. before running "python3 Main.py"):
# export QT_QPA_PLATFORM=xcb
# Without this windows can not be moved, resizing them does not work properly, and APE can not render the Panda3D widget.
ForceOverwriteXWayland = True
if os.environ.get("XDG_SESSION_TYPE") == "wayland":
    print("Detected Wayland session.")
    if "QT_QPA_PLATFORM" not in os.environ or ForceOverwriteXWayland:
        print("Forcing PyQt6 to use XWayland by setting QT_QPA_PLATFORM=xcb.")
        os.environ["QT_QPA_PLATFORM"] = "xcb"
    else:
        print(f"QT_QPA_PLATFORM already set to '{os.environ['QT_QPA_PLATFORM']}', not overriding.")
